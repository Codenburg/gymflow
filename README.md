...
v0.16.0 · Next.js 16 + React 19 + TypeScript + Tailwind v4 + Prisma + PostgreSQL
...
Gym (singleton: price, nombre, horario, direccion, mapsEmbedUrl, socialInstagram, socialWhatsapp, feriados[], promociones[], descuentosDuracion[])
