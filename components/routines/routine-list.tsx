  ...
  if (rutinas.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <p className="text-white/60 text-lg font-medium">No hay rutinas disponibles</p>
        <p className="text-white/60 text-sm mt-1">Crea tu primera rutina para comenzar</p>
      </div>
    );
  }
